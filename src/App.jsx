      ...
      {selected && (<div>
          <div style={{ position: "sticky", top: 0, background: "var(--bg)", zIndex: 10, borderBottom: "1px solid var(--border)", padding: "6px 12px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
              ...
              <button onClick={function() { setHistory([]); setSelectedId(null); window.location.hash = ''; }} style={{ display: "flex", alignItems: "center", gap: 4, padding: "4px 10px", fontSize: 11, color: "var(--text3)", background: "none", border: "1px solid var(--border)", borderRadius: 6, cursor: "pointer" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 3, fontSize: 11, color: "var(--text3)", flexWrap: "wrap" }}>
              <span onClick={function() { setHistory([]); setSelectedId(null); window.location.hash = ''; }} style={{ cursor: "pointer" }}>{viewMode === "garden" ? (lang === "fr" ? "Mon jardin" : "My garden") : (lang === "fr" ? "Accueil" : "Home")}</span>
